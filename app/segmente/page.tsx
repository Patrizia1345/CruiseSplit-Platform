...
function AirlineBadge({ name }: { name: string }) {
  ...
  return (
    <div className="w-12 h-12 rounded-xl flex items-center justify-center text-white text-xs font-bold shrink-0" style={{ backgroundColor: "#0A2342" }}>
      {initials}
    </div>
  );
}
    ...
    <div className="flex flex-col min-h-full font-sans bg-gray-50">
      ...
      <div style={{ backgroundColor: "#0A2342" }} className="px-8 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-4 flex flex-wrap gap-3 items-end shadow-lg">
            ...
            <button onClick={() => { setFrom(to); setTo(from); }} className="mb-0.5 p-2 rounded-full border border-gray-200 text-gray-400 hover:border-[#0EA5E9] hover:text-[#0EA5E9] transition-colors">⇄</button>
            <div className="flex flex-col gap-1 min-w-[140px] flex-1">
      ...
      <div className="max-w-6xl mx-auto w-full px-8 py-8 flex gap-6 flex-1">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          {results.map((segment) => (
            <div key={segment.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-col gap-4 hover:shadow-md transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 flex flex-wrap gap-6 items-center">
                  ...
                  <div className="flex flex-col items-center gap-1 flex-1 min-w-[120px]">
                    <span className="text-xs text-gray-400">{segment.days} Tage</span>
