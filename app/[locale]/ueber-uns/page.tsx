        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 gap-8 sm:grid-cols-2">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-white">{t("solution.heading")}</h3>
            </div>
            <ul className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400 mt-1">{t("team.patriziaTitle")}</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400 mt-1">{t("team.ctoTitle")}</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400 mt-1">{t("team.cooTitle")}</div>
              </div>
            </div>
          </div>
        </div>
