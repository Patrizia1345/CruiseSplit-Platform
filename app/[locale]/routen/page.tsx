    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-8 py-10 flex flex-col gap-12">
        ...
        <section>
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-1">
              <h2 className="text-xl font-bold" style={{ color: "#0A2342" }}>{t("riverHeading")}</h2>
              <span className="text-xs px-2 py-1 rounded-full text-white font-semibold" style={{ backgroundColor: "#B22222" }}>{t("newBadge")}</span>
            </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold">{t("oceanDivider")}</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
